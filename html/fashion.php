...
<div class="container-fluid"><!-- open conytainer-->
  <div class="row"><!-- open row1-->
   ...
   <div class="col-sm-12"><!-- open col 1-->
    ...
    <div class="col-xs-12 col-md-10"><!-- open col 2-->
          ...
          <ol class="carousel-indicators"><!--carousel indicators-->
           ...
           <div class="carousel-inner">
             <?php
              $query = "select * from fashion ORDER BY id DESC LIMIT 4";
              ...
              if($row > 0){
                while($fetchdata = mysqli_fetch_array($fetch)){
                  $act++;
                  $chact = ($act == 1) ? "active" : "" ;
                  $article_image = $fetchdata['article_image'];                 
                  $article_image = "<img src=../images/".$article_image." style='max-height:400px;' width='1832' alt='banner1'/>";

                  echo "
                  <div class='item $chact'>$article_image
